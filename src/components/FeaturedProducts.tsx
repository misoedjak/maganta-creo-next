  ...
  return (
    <section className="py-12 md:py-24 bg-white relative overflow-hidden border-t border-brand-magenta/5">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex lg:grid lg:grid-cols-4 items-start gap-4 md:gap-6 overflow-x-auto lg:overflow-visible pb-8 lg:pb-0 snap-x snap-mandatory scroll-smooth -mx-6 px-6 md:-mx-12 md:px-12 lg:mx-0 lg:px-0 scroll-pl-6 md:scroll-pl-12 lg:scroll-pl-0 scrollbar-none">
          {products.map((product, idx) => {
            const formattedPrice = `${formatPrice(product.price)} / ${product.priceUnit}`;
            return (
              <div 
                key={product.id} 
                className="min-w-[75vw] sm:min-w-[45vw] lg:min-w-0 snap-start snap-always shrink-0 lg:shrink flex w-full"
              >
                <motion.div
                  ...
                  className="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:-translate-y-2 hover:shadow-xl hover:shadow-brand-magenta/10 hover:border-[#be3168]/20 transition-all duration-300 flex flex-col w-full"
                >
                  {/* Image container */}
